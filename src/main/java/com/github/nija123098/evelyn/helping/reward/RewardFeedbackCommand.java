...
public class RewardFeedbackCommand extends AbstractCommand {
    ...
    @Command
    public void feedback(MessageMaker maker, @Argument User user, @Argument Integer amount, @Argument(optional = true, replacement = ContextType.NONE) String s) {
        ...
        maker.getHeader().clear().append("My bot devs liked your feedback! Here is a reward for your suggestion.");
        if (!s.isEmpty()){
