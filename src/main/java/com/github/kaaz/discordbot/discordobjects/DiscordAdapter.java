package com.github.kaaz.discordbot.discordobjects;

import com.github.kaaz.discordbot.botconfig.BotConfig;
import com.github.kaaz.discordbot.discordobjects.wrappers.*;
import com.github.kaaz.discordbot.discordobjects.wrappers.event.DiscordEvent;
import com.github.kaaz.discordbot.discordobjects.wrappers.event.EventDistributor;
import com.github.kaaz.discordbot.discordobjects.wrappers.event.EventListener;
import com.github.kaaz.discordbot.discordobjects.wrappers.event.events.UserRolesUpdate;
...
public class DiscordAdapter {
    ...
    static {
        ...
        Reflections reflections = new Reflections("com.github.kaaz.discordbot.discordobjects.wrappers.event.events");
