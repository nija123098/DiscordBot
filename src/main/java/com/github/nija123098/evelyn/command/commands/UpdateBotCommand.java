...
public class UpdateBotCommand extends AbstractCommand {
    ...
    public void command(MessageMaker maker) throws IOException {
        ...
        ExecuteShellCommand.commandToExecute(commandPrefix + ConfigProvider.updateScripts.pull_script());
        if (ExecuteShellCommand.getOutput().contains("Already up-to-date.")) {
            ...
            ExecuteShellCommand.commandToExecute(commandPrefix + ConfigProvider.updateScripts.build_script());
            if (ExecuteShellCommand.getOutput().contains("BUILD SUCCESS")) {
                ...
                ExecuteShellCommand.commandToExecute(commandPrefix + ConfigProvider.updateScripts.update_script());
