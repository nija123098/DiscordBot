...
public class ConfigLoader {
    ...
    public static ConfigurationProvider configurationProvider() {
        ...
        ConfigFilesProvider configFilesProvider = () -> Arrays.asList(Paths.get("BotConfig.yaml"), Paths.get("URLs.yaml"), Paths.get("PasteBinSettings.yaml"), Paths.get("CacheSettings.yaml"));
