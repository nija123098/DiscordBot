...
public class GameTimeFavorFactorConfig extends AbstractConfig<Float, Guild> {
    public GameTimeFavorFactorConfig() {
        super("current_money", "linked_game_favor_factor", ConfigCategory.FAVOR, 2f, "The factor by which favor is bestowed on a guild user for 5 minutes of linked game time");
    }
}
