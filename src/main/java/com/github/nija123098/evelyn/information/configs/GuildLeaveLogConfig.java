 ...
 * @since 1.0.0
 */
public class GuildLeaveLogConfig extends AbstractConfig<Set<String>, Guild> {
    public GuildLeaveLogConfig() {
        super("guild_leave_log", "", ConfigCategory.STAT_TRACKING, new HashSet<>(0), "Record of guilds leaving and joining");
    }
    ...
    public void handle(DiscordGuildLeave leave) {
        ...
        maker.withAuthor(owner).withAuthorIcon(ConfigProvider.URLS.redArrowPng());
