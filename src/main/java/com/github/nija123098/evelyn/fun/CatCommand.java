...
public class CatCommand extends AbstractCommand {
    ...
    private static final String DID_NOT_WORK = "Unfortunately I can't seem to get any cats for you right now. " + EmoticonHelper.getChars("crying_cat_face", false);
    private static final String URL;

    static {
        String builder = "http://thecatapi.com/api/images/get?type=gif&format=html";
        if (ConfigProvider.AUTH_KEYS.catApiToken() != null)
            builder += "&api_key=" + ConfigProvider.AUTH_KEYS.catApiToken();
        URL = builder;
    }
