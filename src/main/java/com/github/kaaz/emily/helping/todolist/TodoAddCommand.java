...
public class TodoAddCommand extends AbstractCommand {
    ...
    @Command
    public void command(User user, MessageMaker maker, @Argument(optional = true, replacement = ContextType.NONE, info = "The delay") Time time, @Argument(info = "The thing to remind you of") String arg){
