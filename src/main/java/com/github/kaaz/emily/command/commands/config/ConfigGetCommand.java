 ...
 */
public class
ConfigGetCommand extends AbstractCommand {
    public ConfigGetCommand(ConfigCommand command) {
        super(command, "get", null, BotRole.USER, null, null, null);
    }
    @Command
    public <T extends Configurable> void command(@Convert AbstractConfig<?, T> config, @Convert T target, MessageHelper helper, String arg){
