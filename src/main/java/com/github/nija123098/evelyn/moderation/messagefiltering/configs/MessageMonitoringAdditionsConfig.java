...
public class MessageMonitoringAdditionsConfig extends AbstractConfig<Set<MessageMonitoringLevel>, Channel> {
    public MessageMonitoringAdditionsConfig() {
        super("current_money", "language_monitoring_channel_additions", ConfigCategory.STAT_TRACKING, new HashSet<>(0), "The channel based additions of message monitoring");
    }
}
